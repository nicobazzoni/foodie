...
const BasketScreen = () => {
    ...
    useEffect(() => {
        //loops through items and creates object where key exists and pushes several items (20 chickens) in one key
  ...
  return (
    <SafeAreaView className='flex-1 bg-white'>
      <View className='flex-1 bg-gray-100'>
        ...
        <View className='flex-row items-center space-x-2 px-4 py-3 bg-whote my-5'>
            <Image 
            source={{
        ...
        <View className="p-5 bg-white mt-5 space-x-y">
